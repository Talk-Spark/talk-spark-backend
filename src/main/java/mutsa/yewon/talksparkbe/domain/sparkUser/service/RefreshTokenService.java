...
public class RefreshTokenService {
    ...
    public void saveRefreshToken(String refreshToken, Long sparkUserId) {
        String key = "refresh:user" + sparkUserId;
        redisTemplate.opsForValue().set(key, refreshToken);
        redisTemplate.expire(key, REFRESH_TOKEN_EXPIRATION, TimeUnit.SECONDS);
    }
    
    public Map<String, String> getNewRefreshToken(Map<String, Object> userInfo, String refreshToken) {
...
//        Map<String, Object> userInfo = jwtUtil.validateToken(refreshToken);
        ...
        saveRefreshToken(newRefreshToken, sparkUserId);
